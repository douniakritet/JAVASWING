...
TableActionEvent event = new TableActionEvent() {
            ...
            if (row != -1) {
                ...
                String dateD = table.getModel().getValueAt(row, 2).toString();
                String dateF = table.getModel().getValueAt(row, 3).toString();
                ...
                updateForm.setArtistData(idToUpdate, name, dateD, dateF,lieu);
            } else {
    ...
    // Get the ID of the exposition to be deleted
    ...
    try {
        ...
        PreparedStatement pstTransaction = (PreparedStatement) con.prepareStatement("DELETE FROM transaction WHERE idExposition = ?");
        ...
        PreparedStatement pstExposition = (PreparedStatement) con.prepareStatement("DELETE FROM exposition WHERE idE = ?");
