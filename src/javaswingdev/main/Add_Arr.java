 ...
 * @author ME1
 */
public class Add_Arr extends javax.swing.JFrame {
...
SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        String dateNaissanceStr = dateFormat.format(dateNaissance);
            pst = (PreparedStatement) con.prepareStatement("INSERT INTO artiste (nom, nationalite, dateNaissance) VALUES (?, ?, ?)");
            pst.setString(1, nom);
            pst.setString(2, nationalite);
            pst.setString(3, dateNaissanceStr); // Set the third parameter
            ...
            Logger.getLogger(Add_Arr.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Add_Arr.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
