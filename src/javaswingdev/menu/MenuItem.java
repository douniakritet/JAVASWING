...
private JMenuItem selectedItem; // Attribut pour stocker l'élément de menu sélectionné

    // Autres membres de la classe

    public JMenuItem getMenuItem() {
        JMenuItem menuItem = new JMenuItem("Article");
        menuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                // Stocker l'élément de menu sélectionné dans l'attribut
                selectedItem = (JMenuItem) e.getSource();
                // Appeler une méthode pour gérer l'élément de menu sélectionné
    ...
    private void handleSelectedMenuItem() {
        // Ici, vous pouvez effectuer des actions spécifiques en fonction de l'élément de menu sélectionné
        if (selectedItem != null) {
            System.out.println("L'élément de menu '" + selectedItem.getText() + "' a été sélectionné.");
            // Réinitialiser l'élément de menu sélectionné après traitement
            selectedItem = null;
        }
    }
